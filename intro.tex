...
Furthermore, they were able to define the guarded fragment of counting logic $\GFC$, which characterises $\RCR$ in the same way as $\C{2}$ characterises classical $\CR$.
