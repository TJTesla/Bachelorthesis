...
We have seen that this cannot be done for the class of all total structures.
...
\begin{proof}
	...
	\begin{proof}
		...
		Since $C=C'$, it follows that $v\in C'$ and the set of all $\mathbf x\in \mathbf{C'}$ with $v\in \set(\mathbf x)$ induces a connected subgraph in $J'$.
	...
	Then for every $R\in \sigma$, if $\mathbf x\in R^{\mathfrak C'}$, then $\phi(\mathbf x)\in R^{\mathfrak A}$.
