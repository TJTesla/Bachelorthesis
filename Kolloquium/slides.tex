...
\begin{document}
	...
	\begin{frame}{Relational Colour Refinement (RCR)}
		\begin{itemize}
			...
			and
			$$\operatorname{stp}(\mathbf a, \mathbf b)=\{(i,j)\in [n]\times[m] : \mathbf a_i = \mathbf b_j\}$$
			\item For relational structure $\mathfrak A$ and all tuples $\mathbf a\in \bigcup_{R\in\sigma}R^{\mathfrak A}$:
			\begin{itemize}
