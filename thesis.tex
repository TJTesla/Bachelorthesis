...
\begin{abstract}
	...
	Concretely, we consider two possible extensions of the algorithm to all structures and to structures with relations and unary functions.
	We find two logical characterisations but disprove the existence of a characterisation through homomorphism counting.
	Furthermore, we discuss for which restrictions on relational structures the characterisation through homomorphism counting remains and present results for two restrictions. 
	One for which the characterisation holds and one for which it does not.
\end{abstract}
