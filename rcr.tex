...
\begin{figure}
	...
	\hspace*{\fill}
	\subcaptionbox{The coloured multigraph $\mathcal{G}_{\mathfrak A}$, where the blue circle represents $U_R$ and the red rectangles represent $U_T$. \label{fig:transformedMultigraph}}[0.49\textwidth]{
		\centering
